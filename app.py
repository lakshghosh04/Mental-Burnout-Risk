...
path = "Data/burnout_unified.csv"
st.caption("Using Data/burnout_unified.csv. Make sure this file is committed to the repo.")

# ---- Load data
try:
    df = pd.read_csv(path)
except FileNotFoundError:
    st.error("Data/burnout_unified.csv not found. Run your prep script and commit the file to the repo.")
    st.stop()
...
needed = ["age","gender","hours_social","sleep_hours","work_hours","target"]
